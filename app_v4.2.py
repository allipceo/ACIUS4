# app_v4.2.py - AICU S4 고급통계 Week2 구현 (예상 점수 + 합격 확률)
...
def create_app():
    """AICU S4 v4.2 - 고급통계 Week2 구현 (예상 점수 + 합격 확률)"""
    app = Flask(__name__)
    
    # 앱 설정 (세션 제거, 단순화)
    app.config['SECRET_KEY'] = 'aicu_season4_v4_2_predicted_scores'
...
if __name__ == '__main__':
    ...
    print("============================================================")
    print("🚀 AICU S4 v4.2 - 고급통계 Week2 구현 (예상 점수 + 합격 확률)")
    print("📍 URL: http://localhost:5000")
    print("📋 v4.2 Week2 개선 사항:")
