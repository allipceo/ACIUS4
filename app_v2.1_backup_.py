...
def register_blueprints(app):
    ...
    # =============================================================
    # Week2 퀴즈 API 추가 (quiz_routes_backup.py 직접 사용)
    # =============================================================
    try:
        # 서대리 수정: quiz_routes_backup.py 직접 사용 (완전한 API 포함)
        from routes.quiz_routes_backup import quiz_bp
        app.register_blueprint(quiz_bp, url_prefix='/api/quiz')
        print("✅ Week2 퀴즈 API 등록 성공 (quiz_routes_backup.py)")
    except ImportError as e:
        print(f"❌ Week2 퀴즈 API 등록 실패: {e}")
        print("📋 확인사항:")
