# app_v1.6.py - AICU S4 Week2 메인 앱 (f-string 오류 수정 완료)
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("🚀 AICU Season 4 Week 2 서버 시작 (app_v1.6 - f-string 오류 수정 완료)")
    print(f"📍 URL: http://localhost:{port}")
    print(f"🔧 디버그 모드: {debug_mode}")
    print("📋 수정 사항:")
    print("   ✅ f-string 구문 오류 완전 해결")
    print("   ✅ JavaScript 중괄호 올바른 이스케이프")
