# app_v4.5.py - AICU S4 고급통계 Week3 구현 (오답 분석 + 개인 맞춤 인사이트) + 레이어별 조건부 버튼 로직
...
def create_app():
    """AICU S4 v4.5 - 고급통계 Week3 구현 (오답 분석 + 개인 맞춤 인사이트) + 레이어별 조건부 버튼 로직"""
    app = Flask(__name__)
    
    # 앱 설정 (세션 제거, 단순화)
    app.config['SECRET_KEY'] = 'aicu_season4_v4_5_layer_navigation'
...
if __name__ == '__main__':
    ...
    print("============================================================")
    print("🚀 AICU S4 v4.5 - 고급통계 Week3 구현 (오답 분석 + 개인 맞춤 인사이트) + 레이어별 조건부 버튼 로직")
    print("📍 URL: http://localhost:5000")
    print("📋 v4.5 레이어별 조건부 버튼 로직 구현:")
    print("   ✅ 기본학습 레이어1 (초기화면): '홈으로' 버튼")
    print("   ✅ 기본학습 레이어2 (문제풀이): '기본학습메뉴로' 버튼")
    print("   ✅ 대분류학습 레이어1 (초기화면): '홈으로' 버튼")
    print("   ✅ 대분류학습 레이어2/3 (문제풀이): '대분류메뉴로' 버튼")
    print("   ✅ URL 파라미터 기반 모드 구분 (기본학습/대분류학습)")
    print("   ✅ DOM 상태 기반 레이어 구분 (초기화면/문제풀이)")
    print("   ✅ 동적 버튼 텍스트 및 함수 변경")
