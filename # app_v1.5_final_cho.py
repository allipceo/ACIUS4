# app_v1.5_final_cho.py - AICU S4 Week2 (조대표님 전용, f-string 오류 수정)
        ...
        <body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
            <div class="container mx-auto px-4 py-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-xs text-red-500 mt-1">🗓️ 시험일: 2025년 9월 13일 (D-""" + str(ceo_info['days_left']) + """)</p>
                </div>
                ...
                <!-- D-Day 특별 박스 -->
                <div class="bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg shadow-lg p-6 mb-8 text-center">
                    <h2 class="text-2xl font-bold mb-2">⏰ 시험까지</h2>
                    <div class="text-6xl font-bold mb-2">D-""" + str(ceo_info['days_left']) + """</div>
                    <p class="text-lg">매일 """ + str(ceo_info['daily_needed']) + """문제씩 풀면 완주 가능!</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <button onclick="location.href='/api/debug/session'" 
            ...
            <div class="container mx-auto px-4 py-8">
                <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded p-4 mb-6">
                        <p class="text-blue-700">사용자: <strong>조대표</strong></p>
            ...
            <div class="container mx-auto px-4 py-8">
                <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="bg-green-50 border border-green-200 rounded p-4 mb-6">
                        <p class="text-green-700">사용자: <strong>조대표</strong></p>
            ...
            <div class="container mx-auto px-4 py-8">
                <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="bg-purple-50 border border-purple-200 rounded p-4 mb-6">
                        <p class="text-purple-700">사용자: <strong>조대표</strong></p>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" value="D-""" + str(ceo_info['days_left']) + """" readonly
                    ...
                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="text-center p-4 bg-white rounded border">
                                <div class="text-2xl font-bold text-purple-600">D-""" + str(ceo_info['days_left']) + """</div>
                                <div class="text-sm text-gray-600">시험까지 남은 일수</div>
                            </div>
                            
                            <div class="text-center p-4 bg-white rounded border">
                                <div class="text-2xl font-bold text-blue-600">""" + str(ceo_info['daily_needed']) + """</div>
                        ...
                        <div class="mt-4 p-3 bg-yellow-100 border border-yellow-300 rounded">
                            <p class="text-yellow-800 text-sm">
                                💡 <strong>학습 권장사항:</strong> 하루 """ + str(ceo_info['daily_needed']) + """문제씩 풀면 시험 전 완주 가능합니다.
                            </p>
                        </div>
                    </div>
    ...
    def internal_error(error):
        ...
        <body class="bg-gray-100 min-h-screen flex items-center justify-center">
            <div class="bg-white p-8 rounded-lg shadow-lg text-center">
                ...
                <p class="text-gray-600 mb-4">서버 내부 오류가 발생했습니다</p>
                <a href="/home" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">🏠 대문으로</a>
            </div>
        </body>
        </html>
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("🚀 AICU Season 4 Week 2 서버 시작 (조대표님 전용)")
    print(f"📍 URL: http://localhost:{port}")
    print(f"🔧 디버그 모드: {debug_mode}")
    print("👤 조대표님 기본 정보:")
    print("   • 이름: 조대표")
    print("   • 전화번호: 010-2067-6442")
    print("   • 시험일자: 2025년 9월 13일")
    print("   • 자동 로그인: 활성화")
    print("🔒 수정 사항:")
    print("   ✅ f-string 구문 오류 완전 해결")
    print("   ✅ 모든 HTML 문자열 일반 문자열로 변경")
    print("   ✅ 조대표님 정보 자동 입력")
    print("   ✅ D-Day 실시간 계산")
    print("="*60)
