...
# -*- coding: utf-8 -*-
"""
BROKER - Create 23rd Round Data
기존 마스터 파일에 23회 데이터 추가
    ...
    if new_data_rows:
        ...
        try:
            ...
            for layer1 in ['관계법령', '손보1부', '손보2부']:
                layer_count = len(verification_df[(verification_df['EROUND'] == 23) & (verification_df['LAYER1'] == layer1)])
                print(f"  23회 {layer1}: {layer_count}개")
...
def main():
    """메인 실행 함수"""
    success = create_23rd_round_data()
